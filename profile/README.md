...
Для разработчиков:
- [Ядро](https://github.com/meme-bank/core), [сервер авторизации](https://github.com/meme-bank/enclave), [веб-клиент](https://github.com/meme-bank/webclient) самого проекта является свободным ПО (лицензируется по AGPLv3), поэтому мы только рады, если вы поможете в разработке
- [Компоненты для разработки UI](https://github.com/meme-bank/ui-kit) также лицензируются под свободной лицензией (MPLv2)
